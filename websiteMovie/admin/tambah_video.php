...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO movies (slug, title, description, image) VALUES (?, ?, ?, ?)";
    $stmt = $conn->prepare($sql);
    $stmt->bind_param('ssss', $slug, $title, $description, $poster); 
    if ($stmt->execute()) {
                ...
                <ul>
                    ...
                    <li class="menu-item">
                      <a href="admin-crud.php">
                        ...
                        <span class="menu-title">Crud Data Film</span>
                      </a>
                    </li>
                    <li class="menu-item">
                      <a href="#">
                    ...
                    <li class="menu-item">
                      <a href="index.php">
                        ...
                        <span class="menu-title">Halaman Movie</span>
                      </a>
                    </li>
