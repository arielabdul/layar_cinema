    ...
    <div class="container">
        ...
        <?php else: ?>
            <div class="not-found-container">
                <h2>Maaf, saat ini Film atau Serial TV "<strong><?php echo htmlspecialchars($search); ?></strong>" sedang tidak tersedia.</h2>
                <div class="help-section">
                    ...
                    <ul>
                        ...
                        <li>Jika masih tidak ada hasil, gunakan halaman request untuk me-request film atau serial TV yang diinginkan.</li>
                    </ul>
                </div>
            </div>
        <?php endif; ?>
