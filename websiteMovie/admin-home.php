...
<body>
  ...
  _____________________________________________________
    <p>
      ...
      Pada halaman home, Admin hanya bisa melihat tampilan welcome dengan sidebar yang terdapat beberapa pilihan seperti Home, List Film, Tambah List Film, dan Logout.
    ...
    <div class="layout">
      <main class="content">
        ...
        <section class="welcome-section">
          <h1>Welcome, Admin!</h1>
          <p>Selamat datang di dashboard admin. Nikmati kemudahan dalam mengelola konten film dan serial TV Anda.</p>
        </section>
        <!-- Konten lain dapat ditambahkan di sini -->
      </main>
