...
if (isset($_GET['search']) && !empty(trim($_GET['search']))) {
    ...
    // Query hanya untuk series
    $query = "SELECT * FROM movies WHERE kategori = 'series' AND title LIKE '%$search%'";
} else {
    $query = "SELECT * FROM movies WHERE kategori = 'series'";
}
    ...
    <div class="navbar">
        <div class="navbar-container">
            ...
            <div class="search-container-navbar">
                <form method="GET" action="search-series.php">
    ...
    <div class="container">
        ...
        <?php else: ?>
            <div class="not-found-container">
                <h2>Maaf, saat ini Serial TV "<strong><?php echo htmlspecialchars($search); ?></strong>" sedang tidak tersedia.</h2>
                <div class="help-section">
                    <h3>Bantuan:</h3>
                    <ul>
                        <li>Format pencarian yang benar ialah <strong>JUDUL + TAHUN RILIS SERIAL</strong> (jika tidak tahu tahun rilis, silahkan cek Google atau IMDb terlebih dahulu).</li>
                        <li>Pastikan penulisan judul sudah benar, perhatikan text atau typo saat mencari.</li>
                        <li>Jika masih tidak ada hasil, gunakan halaman request untuk me-request serial TV yang diinginkan.</li>
                    </ul>
                </div>
            </div>
        <?php endif; ?>
