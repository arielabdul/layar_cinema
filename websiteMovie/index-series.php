      ...
      <div class="movie-list-container">  
          <div class="movie-list-wrapper">
              <div class="movie-list">
                  <?php while ($series = mysqli_fetch_assoc($result_series)) { ?>
                      <div class="movie-list-item">
                      <a href="detail.php?slug=<?php echo $series['slug']; ?>"><img src="<?php echo $series['url_poster']; ?>" alt="<?php echo $series['title']; ?>" class="movie-list-item-img"></a>
                      </div>
                  <?php } ?>
              </div>
          </div>
